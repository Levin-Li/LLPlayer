...
//  EncodeDemo
//
//  Created by luo luo on 02/03/2018.
...
-(void)testYuvConvertH264
{
    ...
    int y_size;
    int framecnt=0;
    NSString *input_str= [NSString stringWithFormat:@"resource.bundle/%@",@"test_yuv420p_320x180.yuv"];
    NSString *input_nsstr=[[[NSBundle mainBundle]resourcePath] stringByAppendingPathComponent:input_str];
    FILE *in_file = fopen([input_nsstr UTF8String], "rb");   //Input raw YUV data
...
//    outputfmt = pFormatCtx->oformat;
    ...
    pCodecCtx->codec_id = outputfmt->video_codec;//AV_CODEC_ID_H264
